...
const (
	RoleAgentDeveloper    Role = "agent_developer"
	RoleToolOperator      Role = "tool_operator"
...
func (u User) Validate() error {
	...
	switch u.Role {
	case RoleAgentDeveloper, RoleToolOperator, RoleSecurityReviewer, RoleComplianceAuditor:
	default:
