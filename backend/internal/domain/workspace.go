...
type Workspace struct {
	...
	RiskScore        RiskRange       `json:"risk_score"`
...
func (s Workspace) Validate() error {
	...
	if err := s.RiskScore.Validate(); err != nil {
		return err
	}
...
func (s Workspace) CanAcceptExecutionRequests() bool { return s.Status == WorkspaceActive }
